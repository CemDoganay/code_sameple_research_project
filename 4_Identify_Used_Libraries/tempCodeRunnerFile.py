...
csv_used_libraries_location = 'C:\\Users\\dogan\Desktop\\tru_repo\\wip-jetpack-code\\4_Identify_Used_Libraries\\used_libraries_androidx_and_java.csv'
csv_used_classes_location = 'C:\\Users\\dogan\Desktop\\tru_repo\\wip-jetpack-code\\4_Identify_Used_Libraries\\used_classes_androidx_and_java.csv'
csv_project_summary_location = 'C:\\Users\\dogan\Desktop\\tru_repo\\wip-jetpack-code\\4_Identify_Used_Libraries\\project_summary_androidx_and_java.csv'
repo_location = 'C:\\Users\\dogan\\Desktop\\f-droid_cloned_repos'

# opens the cvs files:
with open(csv_androidx_and_java_location, 'r') as csv_androidx_and_java, \
    ...
    csv_androidx_and_java_reader = csv.reader(csv_androidx_and_java)
    ...
    for line_ in csv_androidx_and_java_reader:

        # name of the app:
        app_name = line_[0]

        # if AndroidX or else:
        androidx_and_java = line_[1]

        # app location:
        app_location = repo_location + "\\" + app_name

        # checks if app uses AndroidX and file path exist:
        if androidx_and_java == 'Java' and os.path.isdir(app_location):
        ...
        elif androidx_and_java == 'Java':
            print('ERROR: directory of ' + app_name + ' is missing!')
